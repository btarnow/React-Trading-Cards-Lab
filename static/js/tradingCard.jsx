...
ReactDOM.render(<TradingCardContainer />, document.querySelector('.grid'))

// ReactDOM.render(
//   <TradingCard name="Off By One" skill="pinching" imgUrl="/static/img/off-by-one.jpeg" />,
//   document.querySelector('#off-by-one'),
// );

// ReactDOM.render(
//   <TradingCard name="Merge" skill="coding" imgUrl="/static/img/merge.png" />,
